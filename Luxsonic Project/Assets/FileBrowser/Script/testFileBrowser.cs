...
public class testFileBrowser : MonoBehaviour {
	...
	void Start () {
		...
		//fb.guiSkin = skins[0]; //set the starting skin (we have none)
	...
	void OnGUI(){
        ...
        //These two lines represent baing able to recursively search folders automatically and to change how 
