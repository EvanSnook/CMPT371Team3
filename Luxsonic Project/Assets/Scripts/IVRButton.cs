...
namespace buttons
{
    public enum ButtonType
    {
        ...
        RESIZE_BUTTON, FILTER_BUTTON, CLOSE_BUTTON, RESTORE_COPY_BUTTON, SELECT_ALL_COPIES_BUTTON, DESELECT_ALL_COPIES_BUTTON, TRAY_SCROLL_UP_BUTTON, TRAY_SCROLL_DOWN_BUTTON, NONE, DIRECTORY_BUTTON, FILE_BUTTON,
